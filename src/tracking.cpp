...
public:
  ...
  : Node("tracking")
  {
    subscription_ = this->create_subscription<object_analytics_msgs::msg::TrackedObjects>(
      "/object_analytics/tracking", std::bind(&MinimalSubscriber::topic_callback, this, _1));
  }

private:
  void topic_callback(const object_analytics_msgs::msg::TrackedObjects::SharedPtr msg)
  {
  ...
  rclcpp::Subscription<object_analytics_msgs::msg::TrackedObjects>::SharedPtr subscription_;
};
