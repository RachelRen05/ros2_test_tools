...
public:
  ...
  : Node("localization")
  {
    subscription_ = this->create_subscription<object_analytics_msgs::msg::ObjectsInBoxes3D>(
      "/object_analytics/localization", std::bind(&MinimalSubscriber::topic_callback, this, _1));
  }

private:
  void topic_callback(const object_analytics_msgs::msg::ObjectsInBoxes3D::SharedPtr msg)
  {
  ...
  rclcpp::Subscription<object_analytics_msgs::msg::ObjectsInBoxes3D>::SharedPtr subscription_;
};
